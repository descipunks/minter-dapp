const contractAddress = "YOUR CONTRACT xyz"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the DesciPunks NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The DesciPunks NFT Project is a decentralized, open-source project that aims to decentralize health."  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
